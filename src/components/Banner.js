...
import headerImg from "../images/lineBackground.png";

export const Banner = () => {
    const [loopNum, setLoopNum] = useState(0);
    const[isDeleting, setIsDeleting] = useState(false);
    const toRotate = ["Front-end", "Back-end", "Algorithms", "API's", "and more"]
        ...
        <section  className="banner" id="home">
            <Container>
                <Row className="align-items-center">
                    <Col xs={12} md={6} xl={7}>
                    <span className="tagline">Hello my name is Julio Ledezma</span>
                    <h1>{'I develop '}<span className="wrap">{text}</span></h1>
